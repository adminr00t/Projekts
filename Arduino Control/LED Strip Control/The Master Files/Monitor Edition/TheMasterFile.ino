...
#pragma region Weird Color Patterns
DEFINE_GRADIENT_PALETTE(paintPattern_gp){
    0, 181, 64, 155,
    17, 78, 58, 88,
    34, 107, 68, 125,
    51, 163, 70, 139,
...
DEFINE_GRADIENT_PALETTE(synthpat_gp){
    0, 30, 209, 190,
    17, 30, 209, 190,
    34, 30, 209, 190,
    51, 91, 153, 178,
...
CRGBPalette16 paintingPattern = paintPattern_gp;
CRGBPalette16 synthPattern = synthpat_gp;
CRGBPalette16 vibeFlame;
CRGBPalette16 patternOfSynth;
CRGBPalette16 synthFlame;
CRGBPalette16 vibeFlameExtra;
#pragma endregion
...
#pragma region Color Pallets
    ...
    vibeFlameExtra = CRGBPalette16(CRGB::DarkRed, CRGB::DeepPink, CRGB::Fuchsia, CRGB(20, 201, 189),
                                   CRGB(29, 185, 174), CRGB(38, 170, 159), CRGB(47, 154, 145), CRGB(56, 139, 130),
                                   CRGB(65, 123, 116), CRGB(74, 108, 101), CRGB(84, 92, 87), CRGB(93, 77, 72),
                                   CRGB(111, 46, 43), CRGB(120, 30, 29), CRGB(120, 30, 29), CRGB(129, 15, 14));
    ...
    synthFlame = CRGBPalette16(CRGB(235, 0, 102), CRGB::Red, CRGB::OrangeRed, CRGB::DarkOrange,
                               CRGB::Orange, CRGB::LightSkyBlue, CRGB::DeepSkyBlue, CRGB::Cyan,
                               CRGB::DeepSkyBlue, CRGB::DarkCyan, CRGB::DodgerBlue, CRGB::Teal,
                               CRGB::Blue, CRGB::BlueViolet, CRGB::DarkOrchid, CRGB::DarkViolet);
#pragma endregion
...
#pragma endregion
    ...
    // colorCycle(synthFlame, startIndex, 255);
    monitorColorCycle(patternOfSynth, startIndex, 100);
...
#pragma region Colors for ArcReactor
    if (avOvertrsh <= 100)
    {
        ...
        for (int i = ArcReactorLEDS - 1; i > overtrsh - 1 && i >= 0; i--)
        {
            ArcReactor[i] = CRGB::Black;
        }
    }
...
#pragma region Colors for Strip1
    if (avOvertrsh <= 75)
    {
        // LED Color
        for (int i = 0; i < overtrsh && i < NUM_LEDS; i++)
